...
public class Article {
	...
	// change 1
	private boolean _markRead; // markread
	...
	public Action toggleMarkRead() {
		_markRead = !_markRead;
		if(_markRead)
			action = new Action(Action.ACTION.READ, _strDatakey);
		else
			action = null;
		return action;
	}

	public void setFeedName(String strFeedName) {
	...
	public void setFeedLink(String strFeedLink) {
	...
	public void setReadLink(String strReadLink) {
	...
	public void setPeekLink(String strPeekLink) {
		_strPeekLink = strPeekLink;
	}

	public String getPeekLink() {
		return _strPeekLink;
	}
	...
	public Article(String strFeedName, String strFeedLink, String strKey,
			String strReadLink, String strTitle, String strPeekLink,
			String strDataKey) {
