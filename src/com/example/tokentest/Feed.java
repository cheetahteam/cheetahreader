...
public class Feed {
	...
	static private boolean markSubscribe = false ;

	public boolean toggleMarkSubscribe() {
		markSubscribe = !markSubscribe;
		return markSubscribe;
	}

	public boolean getMarkSubscribe() {
		return markSubscribe;
	}
	...
	public void setFeedUnsubLink(String unsubLink) {
		_strFeedUnsubLink = unsubLink;
	}

	public String getFeedUnsubLink() {
		return _strFeedUnsubLink;
	}
